          ...
          admin.slice(0, 4).map((element) => (
            <div key={element._id} className="flex flex-col items-center hover:scale-95 transition-transform duration-300">
              <img
                ...
                alt={element.name}
                className="w-40 h-40 object-cover border border-gray-300 rounded-full mb-4 shadow-lg shadow-cyan-300 hover:shadow-2xl hover:shadow-cyan-500 duration-300"
              />
